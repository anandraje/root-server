...
// import Pie_Asia from "./Pie_Asia.js";
...
//   return (
//     <>
//     <div className="">root-servers</div>
...
//           </MarkerClusterGroup>
//         </MapContainer>
//         <div className="flex flex-col justify-between lg:flex-row gap-2 lg:gap-4 w-full overflow-x-auto">
...
//         <Piechart data={aggregatedData} checkedLabels={checkedLabels} />
//           </div>
...
//                     <td className="px-4 py-2">{siteCounts[label] || 0}</td>
//                     <td className="px-4 py-2">{counts[label] || 0}</td>
//                   </tr>
//                 ))}
//                 <tr className="bg-gray-200 text-center">
//                   <td className="px-4 py-2">Total</td>
//                   <td className="px-4 py-2">{totalCount_site}</td>
...
/>
            ...
            <div className="mt-4">
              ...
              <div className="mt-4 bg-white rounded-lg shadow-lg p-4 overflow-x-auto">
                <div className="text-2xl ">Root Instances Table</div>
  <table className="table-auto w-full text-center">
                  <thead>
                    <tr className="bg-gray-200">
                      <th
